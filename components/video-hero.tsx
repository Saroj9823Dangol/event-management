      ...
      <div className="relative h-full  flex flex-col justify-end pb-20 container mx-auto z-20">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif mb-6 text-white leading-[0.9] tracking-tight line-clamp-1">
              {currentEvent.name}
            </h1>
      ...
      <div className="absolute right-0 top-1/2 -translate-y-1/2 flex rotate-90 gap-3 z-30">
        {featuredEvents?.data.map((_, i) => (
          <button
            ...
            className={`transition-all duration-300 h-1 sm:h-2 ${
              i === currentIndex
